...
import { ClearLinksModal } from '@components/mainPage/urlsList/ClearLinksModal';
...
export const UrlsTable = () => {
  ...
  return (
    <>
      ...
      {urls.length > 0 && isAuth === false ?
        <>
          <div className={styles.clearLinksButton}>
            <Button variant="secondary" onClick={() => setIsActive(true)}>Clear all links</Button>
          </div>
          <ClearLinksModal isActive={isActive} setIsActive={setIsActive} />
        </>
        : null
      }
    </>
